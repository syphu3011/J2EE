        ...
        <Space direction="vertical" style={{ width: '100%' }} size={[0, 48]}>
            <Layout>
                <Header style={headerStyle} >
                    <Row gutter={16}>
                        <Col className="gutter-row" span={7}style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                        ...
                        <Col className="gutter-row" span={11}>
                            <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                                <Form.Item label="Sản phẩm cung cấp:"
                                    labelAlign='left'
                                    labelCol={{ span: 7 }}
                                >
                                    <Input
