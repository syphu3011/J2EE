...
const MenuRight = (check: { isLogin: boolean }) => {
            ...
            ? [
                  {
                      ...
                      children: [
                          ...
                          {
                              icon: <HistoryOutlined className="large-icon" />,
            ...
            : [
                  {
                      ...
                      children: [
                          ...
                          {
                              icon: (
                                  <PlusCircleOutlined className="large-icon" />
                              ),
                              label: "Đăng ký",
                              key: "createAccount",
    ...
    return (
        <div className="MenuRight">
            ...
            >
                <SignUp
                    onCloseSignUp={handleSignUpFormClose}
                    isLoggedIn={isLoggedIn}
                    setIsLoggedIn={setIsLoggedIn}
                />
            </div>
                    ...
                    extra={
                        <Space>
                            ...
                            <Link
                                to={
                                    !isEmpty
                                        ? "/gio-hang/xac-nhan-thong-tin-giao-hang"
                                        : "#"
                                }
                            >
                                <Button
                                    type="primary"
                                    onClick={!isEmpty ? onClose : onMess}
                                >
                                    Thanh toán
                                </Button>
                            </Link>
